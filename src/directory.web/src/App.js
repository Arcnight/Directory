...
class App extends Component {
    ...
    render() {
        return (
            <Fragment>
                <div className="ui menu asd borderless fixed" style={{ "borderRadius": "0 !important", "border": "0" }}>
                ...
                <div className="mainnav ui sidebar vertical left menu">
                ...
                <div className="pusher">
                    <div className="appbody">
                        <div className="quicknav ui vertical menu left visible">
